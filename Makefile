...
CFLAGS_web := $(CFLAGS_all) $(OFLAGS_web) --js-library ../Empirical/emtools/library_emp.js -s EXPORTED_FUNCTIONS="['_main', '_empCppCallback']" -s DISABLE_EXCEPTION_CATCHING=1 -s NO_EXIT_RUNTIME=1 --embed-file configs
default: evoke
web: evoke.js
all: evoke evoke.js
